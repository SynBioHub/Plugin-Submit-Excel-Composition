...
# Plugin-Submit-Excel-Composition
A very simple submit plugin that returns sbol files with submit information

# Install
## Docker
Run `docker run --publish 8094:5000 --detach --name submit-plug synbiohub/plugin-submit-excel-composition:snapshot`
Check it is up using http://localhost:8094/status.
